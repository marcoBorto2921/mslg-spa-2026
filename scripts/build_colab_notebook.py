...
def build_cells() -> list:
    ...
    cells.append(
        code(
            ...
            "# MSLG2SPA: checkpoints/baseline_bt/mslg2spa/final\n"
            "# SPA2MSLG: checkpoints/baseline_bt/spa2mslg/final/checkpoint-2880\n"
            "#           (best available — baseline_bt_s2m/final not yet saved)\n"
            "# Outputs: {TEAM_NAME}_baseline_bt_MSLG2SPA.txt\n"
            "#          {TEAM_NAME}_baseline_bt_SPA2MSLG.txt\n"
            "import os\n"
            "os.chdir(str(PROJECT_ROOT))\n"
            "S2M_CKPT = f'{PROJECT_ROOT}/checkpoints/baseline_bt/spa2mslg/final/checkpoint-2880'\n"
